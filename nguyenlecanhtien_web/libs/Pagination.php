<?php
	class Paginator{
		...
		var $per_page = 10; //số lượng record trên 1 trang
		var $cur_page = 0; //trang hiện hành (ví dụ: 1, 2, 3)
		...
		public function createLinks() {
			...
			$html  .= "<li><a aria-label='Previous' class = '" . $class . "' href='".$this->base_url . ($this->cur_page - 1) . "'><span aria-hidden='true'>&laquo;</span></a></li>";
